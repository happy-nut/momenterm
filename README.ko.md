...
Momenterm은 GitHub Releases에 올라간 DMG로 배포합니다.

1. 최신 [Release](https://github.com/happy-nut/momenterm/releases)에서 `Momenterm.dmg`를 다운로드합니다.
...
태그를 푸시하면 GitHub Release가 자동으로 생성됩니다.
